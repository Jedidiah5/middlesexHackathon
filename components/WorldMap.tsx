...
const UrbanGlobe = dynamic(() => import("./UrbanGlobe"), {
  ssr: false,
  loading: () => (
    <div className="glass-card flex min-h-[360px] w-full items-center justify-center rounded-2xl">
...
export default function WorldMap({
  ...
  return (
    <div className="glass-card relative overflow-hidden rounded-2xl">
      ...
      <div className="glass-chip pointer-events-none absolute bottom-4 left-4 flex max-w-[min(100%,280px)] flex-wrap items-center gap-2 rounded-xl px-3 py-2 text-[10px] text-black/70">
      ...
      <p className="glass-chip pointer-events-none absolute right-4 top-4 max-w-[200px] rounded-lg px-2 py-1 text-left text-[10px] font-medium leading-snug text-black/55 sm:max-w-none">
